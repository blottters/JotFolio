...
const ICONS = {
  ...
  trash:       <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><polyline points="3 6 5 6 21 6"/><path d="M8 6V4a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v2"/><path d="M19 6l-1 14a2 2 0 0 1-2 2H8a2 2 0 0 1-2-2L5 6"/><line x1="10" y1="11" x2="10" y2="17"/><line x1="14" y1="11" x2="14" y2="17"/></svg>,
};

function RibbonButton({ icon, tip, onClick, active, badge }) {
  return (
    <button onClick={onClick} aria-label={tip} title={tip}
      ...
      {badge > 0 && (
        <span aria-hidden="true"
          style={{
            position: 'absolute', right: 2, top: 2, minWidth: 15, height: 15,
            padding: '0 4px', borderRadius: 99, background: 'var(--ac)', color: 'var(--act)',
            border: '1px solid var(--sb)', display: 'inline-flex', alignItems: 'center',
            justifyContent: 'center', fontSize: 9, lineHeight: 1, fontWeight: 800,
          }}>
          {badge > 99 ? '99+' : badge}
        </span>
      )}
...
export function Ribbon({
  ...
  return (
    <aside aria-label="Quick actions ribbon"
      ...
      <RibbonButton icon={ICONS.trash}       tip="Trash"                       onClick={onTrash}        active={activeRoute === 'trash'} badge={trashCount} />
    </aside>
  );
}

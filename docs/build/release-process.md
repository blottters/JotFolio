...
4. Commit: `git commit -am "release: 0.5.0-alpha.14"`.
5. Tag: `git tag v0.5.0-alpha.14`.
...
https://github.com/blottters/jotfolio/blob/v0.5.0-alpha.14/docs/CHANGELOG.md#050-alpha14---2026-05-04

...
Pre-alpha.14 release history. Bounded-growth rule: the main `CHANGELOG.md` keeps the last 7 alphas; everything older lives here.

For shipped state of the current release line, see [`CHANGELOG.md`](./CHANGELOG.md).
